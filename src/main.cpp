...
TouchChannel channelA(0, &timer, &ticker, GATE_OUT_A, TOUCH_INT_A, ADC_A, &touchA, &ioA, &degrees, &midi, &dac, DAC8554::CHAN_A);
TouchChannel channelB(0, &timer, &ticker, GATE_OUT_B, TOUCH_INT_B, ADC_B, &touchB, &ioB, &degrees, &midi, &dac, DAC8554::CHAN_B);
TouchChannel channelC(0, &timer, &ticker, GATE_OUT_C, TOUCH_INT_C, ADC_C, &touchC, &ioC, &degrees, &midi, &dac, DAC8554::CHAN_C);
TouchChannel channelD(0, &timer, &ticker, GATE_OUT_D, TOUCH_INT_D, ADC_D, &touchD, &ioD, &degrees, &midi, &dac, DAC8554::CHAN_D);
